...
public class RetrieveTestData extends TestBaseClass {
	...
	@FindBy(id = "cr_keystock")
	private WebElement keyStockData;
	...
	public WebElement getKeyStockData() {
		return keyStockData;
	}
	...
	public void EPSPrice(String cmp) {
		...
		if (!getKeyStockData().getAttribute("class").endsWith("open")) {
			getKeyStockData().click();
			WSJUtils.waitForPageLoad();
		}
